    ...
    // Protected routes (inside app shell)
    {
      ...
      children: [
       ...
       // { path: "ai-assistant", name: "ai-assistant", component: () => import("@/views/AIAssistantView.vue") },
        ...
        { path: "admin/requests", name: "admin-requests", component: () => import("@/views/admin/RequestsView.vue"), meta: { roles: ["admin"] } },
        { path: "admin/audit", name: "admin-audit", component: () => import("@/views/admin/AuditView.vue"), meta: { roles: ["admin"] } },
        { path: "lecturer", name: "lecturer-portal", component: () => import("@/views/lecturer/LecturerPortalView.vue"), meta: { roles: ["lecturer"] } },
        { path: "hod/requests", name: "hod-requests", component: () => import("@/views/hod/DepartmentRequestsView.vue"), meta: { roles: ["hod"] } },
